/* VRTSync Admin Hub — Account Settings Page
 * Route: 'account'
 * Allows the admin user to update their display name and password.
 */
AdminRouter.register('account', async function (container) {
  const { apiFetch, showToast } = AdminAPI;
  const user = AdminState.getUser();
  ...
  container.innerHTML = `
    ...
    <div style="max-width:600px;">
      ...
      <div class="card" style="margin-bottom:20px;padding:0;overflow:hidden;">
        <div class="card-header" style="padding:14px 20px;border-bottom:1px solid var(--gray-200,#e5e7eb);">
          <h3 style="margin:0;font-size:15px;font-weight:600;color:var(--navy,#1e3a5f);">Profile</h3>
        </div>
        <div style="padding:20px;">
          ...
          <div style="margin-bottom:16px;">
            ...
            <div class="form-control" style="max-width:340px;background:var(--gray-50,#f9fafb);color:var(--gray-500,#6b7280);cursor:default;">Admin</div>
          </div>
          <div style="margin-bottom:20px;">
      ...
      <div class="card" style="padding:0;overflow:hidden;">
        <div class="card-header" style="padding:14px 20px;border-bottom:1px solid var(--gray-200,#e5e7eb);">
          <h3 style="margin:0;font-size:15px;font-weight:600;color:var(--navy,#1e3a5f);">Change Password</h3>
        </div>
        <div style="padding:20px;">
          <div style="margin-bottom:16px;">
